      ...
      <div className="w-1/2 bg-white flex flex-col justify-center items-center h-full p-12">
        ...
        >
          <div className="w-[80%] rounded-lg mx-auto flex justify-start items-center gap-2 px-2 border border-[#808080] bg-white">
            <AiOutlineMail className="text-blue-1" size={25} />
            <input
          ...
          <div className="w-[80%] relative border border-[#808080] rounded-lg mt-8 mx-auto flex justify-start items-center gap-2 px-2  bg-white">
          ...
          <button className="w-[80%] hover:scale-105 transition-all mx-auto flex justify-center items-center rounded-lg p-4 bg-blue-1 text-white mt-8">
            Login
          </button>

          <p className="text-center mt-5">Don't have an account? <Link to='/register' className="text-blue-1 font-medium">Register here</Link> </p>
        </form>
      </div>
    </div>
  );
